...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ triggerSafety, showLegal }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-surface-light dark:bg-surface-dark relative transition-colors duration-200">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-surface-light dark:bg-surface-dark p-4 safe-area-pb transition-colors duration-200">
        <div className="max-w-3xl mx-auto relative flex items-center gap-3">
         ...
         <div className="text-[10px] text-slate-400 dark:text-slate-500 text-center mt-3 pb-1 max-w-xl mx-auto leading-tight opacity-80">
            <p className="mb-0.5">
               ...
               <button onClick={() => showLegal('terms')} className="hover:text-slate-600 dark:hover:text-slate-300 underline">Terms</button>
               {' '}and{' '}
               <button onClick={() => showLegal('privacy')} className="hover:text-slate-600 dark:hover:text-slate-300 underline">Privacy Policy</button>.
            </p>
